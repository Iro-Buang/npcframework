...
from core.Runtime_Inference_LlamaCPP import (
    RuntimeConfig,
    TurnRequest,
    build_engine,
    warm_engine,
...
from core.Runtime_Prompt_Compiler import ToolSpec
...
# Test turns
TURN_1_TEXT = "Hello. Who are you and what can you do?"
TURN_2_TEXT = "Use tool add to calculate the sum of 2 and 5. Return only the final number."
